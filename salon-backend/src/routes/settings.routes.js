...
// All fields optional: callers may send a partial payload (e.g. only the salon
// name, or only GST settings). The service layer merges over the existing
// profile and enforces the GSTIN-when-enabled rule on the merged result.
...
router.delete('/discounts/:id', requireRole('OWNER'), validate(idSchema), settingsController.deleteDiscount);
